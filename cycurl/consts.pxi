...
CURLOPT_IMPERSONATE = curl.CURLOPT_IMPERSONATE
...
CURLOPT_PROXY_CREDENTIAL_NO_REUSE = curl.CURLOPT_PROXY_CREDENTIAL_NO_REUSE
CURLOPT_SPLIT_COOKIES = curl.CURLOPT_SPLIT_COOKIES
CURLOPT_FORM_BOUNDARY = curl.CURLOPT_FORM_BOUNDARY
CURLOPT_HTTP3_PSEUDO_HEADERS_ORDER = curl.CURLOPT_HTTP3_PSEUDO_HEADERS_ORDER
CURLOPT_HTTP3_SETTINGS = curl.CURLOPT_HTTP3_SETTINGS
CURLOPT_QUIC_TRANSPORT_PARAMETERS = curl.CURLOPT_QUIC_TRANSPORT_PARAMETERS
CURLOPT_HTTP3_SIG_HASH_ALGS = curl.CURLOPT_HTTP3_SIG_HASH_ALGS
CURLOPT_HTTP3_TLS_EXTENSION_ORDER = curl.CURLOPT_HTTP3_TLS_EXTENSION_ORDER
CURLOPT_HTTPHEADER_ORDER = curl.CURLOPT_HTTPHEADER_ORDER
CURLOPT_HTTP3_HTTPHEADER = curl.CURLOPT_HTTP3_HTTPHEADER
CURLOPT_HTTP3_HTTPHEADER_ORDER = curl.CURLOPT_HTTP3_HTTPHEADER_ORDER
CURLOPT_HTTP3_SSL_EC_CURVES = curl.CURLOPT_HTTP3_SSL_EC_CURVES
CURLOPT_WS_HTTPHEADER = curl.CURLOPT_WS_HTTPHEADER
CURLOPT_WS_HTTPHEADER_ORDER = curl.CURLOPT_WS_HTTPHEADER_ORDER
