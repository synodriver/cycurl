...
cdef extern from "curl/curl.h" nogil:
   ...
   # multi interfaces
    ...
    int CURLOPT_TLS_DELEGATED_CREDENTIALS
    ...
    int CURLOPT_PROXY_CREDENTIAL_NO_REUSE
    int CURLOPT_SPLIT_COOKIES
    int CURLOPT_FORM_BOUNDARY
    int CURLOPT_HTTP3_PSEUDO_HEADERS_ORDER
    int CURLOPT_HTTP3_SETTINGS
    int CURLOPT_QUIC_TRANSPORT_PARAMETERS
    int CURLOPT_HTTP3_SIG_HASH_ALGS
    int CURLOPT_HTTP3_TLS_EXTENSION_ORDER
    int CURLOPT_HTTPHEADER_ORDER
    int CURLOPT_HTTP3_HTTPHEADER
    int CURLOPT_HTTP3_HTTPHEADER_ORDER
    int CURLOPT_HTTP3_SSL_EC_CURVES
    int CURLOPT_WS_HTTPHEADER
    ...
    int CURLINFO_POSTTRANSFER_TIME_T
    int CURLINFO_EARLYDATA_SENT_T
    int CURLINFO_HTTPAUTH_USED
    ...
    int CURLMOPT_NETWORK_CHANGED
    int CURLMOPT_NOTIFYFUNCTION
    int CURLMOPT_NOTIFYDATA
    int CURLMOPT_RESOLVE_THREADS_MAX
    int CURLMOPT_QUICK_EXIT
    #CURLE_
    int CURLE_OK
