...
class AsyncWebSocket(BaseWebSocket):
    ...
    async def __anext__(self) -> bytes:
        ...
        if (msg is None) or (flags & m.CURLWS_CLOSE):
    ...
    def _start_io_tasks(self) -> None:
        ...
        self._sock_fd = self.curl.getinfo(m.CURLINFO_ACTIVESOCKET)
    ...
    async def recv_str(self, *, timeout: Optional[float] = None) -> str:
        ...
        if data is None or not (flags & m.CURLWS_TEXT):
