...
if TYPE_CHECKING:
    ...
    SEND_QUEUE_ITEM = tuple[bytes, int]
...
class AsyncWebSocket(BaseWebSocket):
    ...
    async def _read_loop(self) -> None:
        ...
        close_flag = m.CURLWS_CLOSE
        cont_flag = m.CURLWS_CONT
        ping_flag = m.CURLWS_PING
    ...
    async def _write_loop(self) -> None:
        ...
        """
        control_frame_flags: int = m.CURLWS_CLOSE | m.CURLWS_PING
        ...
        try:
            ...
            if not self._coalesce_frames:
                ...
                while True:
                    ...
                    batch: list[tuple[bytes, int]] = [(payload, flags)]
    ...
    async def _send_payload(self, payload: bytes, flags: int) -> bool:
        """
