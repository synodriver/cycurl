...
[![PyPI Downloads](https://static.pepy.tech/badge/cycurl/week)](https://pepy.tech/projects/cycurl)
![PyPI - Python Version](https://img.shields.io/pypi/pyversions/cycurl)
[![PyPI version](https://badge.fury.io/py/cycurl.svg)](https://badge.fury.io/py/cycurl)
...
`cycurl` supports the same browser versions preset as supported by our [fork](https://github.com/lexiforest/curl-impersonate) of [curl-impersonate](https://github.com/lwthiker/curl-impersonate):
